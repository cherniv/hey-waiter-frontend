...
define("QrPrint", ["require", "exports"], function (require, exports) {
    ...
    var PrintKind;
    (function (PrintKind) {
        PrintKind[PrintKind["a4single"] = 0] = "a4single";
        PrintKind[PrintKind["a5single"] = 1] = "a5single";
        PrintKind[PrintKind["a4double"] = 2] = "a4double";
    })(PrintKind || (PrintKind = {}));
    var QrPrint = (function () {
        function QrPrint(vars, qrGen) {
            var _this = this;
            this.vars = vars;
            this.qrGen = qrGen;
            this.showButtons = function (on) {
                $('#print-A4-single').toggle(on);
                $('#print-A5-single').toggle(on);
                $('#print-A4-double').toggle(on);
                $('#close-print-panel').toggle(on);
                _this.showPrintButton(on);
        ...
        QrPrint.prototype.generatePDF = function (kind) {
            var _this = this;
            this.showButtons(false);
            var singleA4 = kind == PrintKind.a4single;
            ...
            var addPage = function (num) {
                var isLast = num >= total - 1;
                _this.qrGen.generate(num, function (data) {
                    ...
                    if (kind == PrintKind.a4double) {
                        ...
                        var x = singleA4 ? 0 : nextPageRequired ? short : 0;
        ...
        QrPrint.prototype.test = function () {
            ...
            var imgData2 = "data:image/jpeg;base64,";
            var doc = new jsPDF('landscape');
            console.log('pdf is created');
            var N = 1;
            for (var i = 0; i < N; ++i) {
                var w = 210, h = w * Math.pow(2, .5);
